...
const Navbar = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] z-50 px-10 flex items-center transition-all duration-300 border-b border-white/10 ".concat(scrolled ? "backdrop-blur-sm" : "backdrop-blur"),
        children: [
    ...
    const handleNavClick = (e, path, scrollId)=>{
        if (scrollId) {
            ...
            if (window.location.pathname === "/") {
                ...
                window.location.href = "/".concat(scrollId ? "#" + scrollId : "");
            }
            setMenuOpen(false);
        } else if (path) {
            setMenuOpen(false);
...
//# sourceMappingURL=src_7fd52881._.js.map